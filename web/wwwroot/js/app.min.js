! function(e, t) {
  ...
  Ft.href = xt.href, he.extend({
    ...
    ajax: function(t, n) {
      function i(t, n, i, a) {
        var c, d, p, w, _, E = n;
        u || (u = !0, l && e.clearTimeout(l), r = void 0, s = a || "",
        x.readyState = t > 0 ? 4 : 0,
        c = t >= 200 && t < 300 || 304 === t,
        i && (w = J(h, x, i)),
        w = Z(h, w, x, c), c ? (h.ifModified && ((_ = x.getResponseHeader("Last-Modified")) && (he.lastModified[o] = _),
        (_ = x.getResponseHeader("etag")) && (he.etag[o] = _)),
        204 === t || "HEAD" === h.type ? E = "nocontent" : 304 === t ? E = "notmodified" :
        (E = w.state, d = w.data, p = w.error, c = !p)) : (p = E, !t && E ||
        (E = "error", t < 0 && (t = 0))), x.status = t, x.statusText = (n || E) + "", c ? v.resolveWith(m, [d, E, x]) :
        v.rejectWith(m, [x, E, p]), x.statusCode(b), b = void 0, f &&
        g.trigger(c ? "ajaxError" : "ajaxSuccess", [x, h, c ? d : p]), y.fireWith(m, [x, E]), f &&
        (g.trigger("ajaxComplete", [x, h]), --he.active || he.event.trigger("ajaxStop")))
      }
...
! function(e, t) {
  ...
  /iPhone|iPod|iPad|Silk|Android|BlackBerry|Opera Mini|IEMobile/.test(n) && e("body").addClass("touch"), /iPhone|iPod|iPad/.test(n) && e(document, ".modal, .aside").on("shown.bs.modal", function(t) {
    ...
    t > 1200 && e(".aside-lg").modal("hide"),
      t > 991 && (e("#aside").modal("hide"), e(".aside-md, .aside-sm").modal("hide")),
