    ...
    theme: "supervan", content: function()
      {
        var t = this;
        return $.ajax({
            url: "/api/contents/" + n, dataType: "json", method: "DELETE"
          }).fail(function(n)
          {
            n.status === 200 ? (t.setType("green"), t.setIcon("fa fa-check-circle"), t.setTitle("Record deleted successfully."), t.setContent(n.responseText), t.onAction = function()
              {
                setTimeout(function()
                {
                  window.history.go(-2)
...
function warning(n)
{
  toastr.warning(n, "Warning", {
    progressBar: !0, positionClass: "toast-bottom-right"
  })
}
...
{
  var i = new String(1..toFixed(t)),
    r,
    u;
  return i = i.substr(2), r = parseInt("1" + i), u = parseFloat("." + i + "01"), n * r * 10 % 10 >= 5 && (n += u), Math.round(n * r) / r
}
function postUnit()
{
  unit = {};
    ...
    theme: "supervan", content: function()
      {
        var t = this;
        return $.ajax({
            url: "/api/units/" + n, dataType: "json", method: "DELETE"
          }).fail(function(n)
          {
            n.status === 200 ? (t.setType("green"), t.setIcon("fa fa-check-circle"), t.setTitle(n.responseText), t.setContent("Record deleted successfully."), t.onAction = function()
              {
